...
import com.wy.listener.DialogListener;
import com.wy.listener.MusicPlayer;
import com.wy.listener.PreView;
...
public class StartFrame extends JFrame {
	...
	public static JLabel jt10 = new JLabel("等级：1");
	...
	// Dialog dia;//创建对话框
	public static ImageIcon background = new ImageIcon(Constant.backGround1);

	// 把背景图片加到label
	public static JLabel label = new JLabel(background);

	// Dialog dia=new Dialog(this, "自定义", false);
	public int scor = 0;// 初始化分数为0

	public static int rank = 0;// 初始化等级为0
	...
	public static boolean changeBack = false;
	...
	/*
	 * private class MenuKeyListener extends KeyAdapter{ public void
	 * keyPressed(KeyEvent e) { int i = e.getKeyCode(); switch (i) { case
	 * KeyEvent.VK_C: System.out.println("111");; break; case KeyEvent.VK_DOWN:
	 * block.moveDown(); break; case KeyEvent.VK_LEFT: block.moveLeft(); break; } }
	 * }
	 */
	/**
	 * 按键监听，上下左右。
	...
	private void addMenu() {
		...
		ji2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				zi = new DialogListener(StartFrame.this, "自定义", false, block, gc);
				zi.setVisible(true);
				if (playing == true)
					block.pause();
			}
		...
		ji4.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				// JDialog dl = new Version(StartFrame.this, "版本信息", false);
			}
		});
		// 调用颜色对话框设置方块颜色
		...
		ji_color.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				Color newFrontColor = JColorChooser.showDialog(StartFrame.this, "设置方块颜色",
						gc.getBlockColor());
				if (newFrontColor != null)
					gc.setBlockColor(newFrontColor);
			}
		});
		StartFrame.this.setJMenuBar(jb1);
		jb1.add(m1);
		jb1.add(m2);
		m1.add(ji1);
		m1.add(jr1);
