...
public class Wall implements Actor {
	...
	public void damageWall(Rectangle bullet, int bulletpower, int bulletdirection) {
		...
		if (bulletpower == 2) {
			if (border[0] != null && border[1] != null
					&& (bulletdirection == 0 || bulletdirection == 1)) {
				if (bullet.intersects(border[0]) && bullet.intersects(border[1])) {
					for (int i = 0; i < 8; i++)
						shape[i] = true;
					border[0] = null;
			...
			if (border[2] != null && border[3] != null
					&& (bulletdirection == 0 || bulletdirection == 1)) {
				if (bullet.intersects(border[2]) && bullet.intersects(border[3])) {
					for (int i = 8; i < 16; i++)
						shape[i] = true;
			...
			if (border[0] != null && border[2] != null
					&& (bulletdirection == 2 || bulletdirection == 3)) {
				if (bullet.intersects(border[0]) && bullet.intersects(border[2])) {
					for (int i = 0; i <= 12; i += 4)
						shape[i] = true;
					for (int i = 1; i <= 13; i += 4)
			...
			if (border[1] != null && border[3] != null
					&& (bulletdirection == 2 || bulletdirection == 3)) {
				if (bullet.intersects(border[1]) && bullet.intersects(border[3])) {
					for (int i = 2; i <= 14; i += 4)
						shape[i] = true;
		...
		if (border[0] != null) {
			...
			if (border[0] != null) {
				if (bullet.intersects(border[0]) && bulletdirection == 1
						&& !(bullet.intersects(b) && ((!shape[2] || !shape[6])
			...
			if (border[0] != null) {
				if (bullet.intersects(border[0]) && bulletdirection == 0
						&& !(bullet.intersects(d) && ((!shape[2] || !shape[6])
								|| (shape[1] && shape[2] && shape[5] && shape[6])))) {
			...
			if (border[0] != null) {
				if (bullet.intersects(border[0]) && bulletdirection == 3
						&& !(bullet.intersects(c) && ((!shape[8] || !shape[9])
								|| (shape[4] && shape[5] && shape[8] && shape[9])))) {
			...
			if (border[0] != null) {
				if (bullet.intersects(border[0]) && bulletdirection == 2
						&& !(bullet.intersects(d) && ((!shape[8] || !shape[9])
								|| (shape[4] && shape[5] && shape[8] && shape[9])))) {
		...
		if (border[1] != null) {
			...
			if (border[1] != null) {
				if (bullet.intersects(border[1]) && bulletdirection == 1
						&& !(bullet.intersects(a) && ((!shape[1] || !shape[5])
								|| (shape[1] && shape[2] && shape[5] && shape[6])))) {
			...
			if (border[1] != null) {
				if (bullet.intersects(border[1]) && bulletdirection == 0
						&& !(bullet.intersects(c) && ((!shape[1] || !shape[5])
								|| (shape[1] && shape[2] && shape[5] && shape[6])))) {
			...
			if (border[1] != null) {
				if (bullet.intersects(border[1]) && bulletdirection == 3
						&& !(bullet.intersects(c) && ((!shape[10] || !shape[11])
								|| (shape[6] && shape[7] && shape[10] && shape[11])))) {
			...
			if (border[1] != null) {
				if (bullet.intersects(border[1]) && bulletdirection == 2
						&& !(bullet.intersects(d) && ((!shape[10] || !shape[11])
								|| (shape[6] && shape[7] && shape[10] && shape[11])))) {
		...
		if (border[2] != null) {
			...
			if (border[2] != null) {
				if (bullet.intersects(border[2]) && bulletdirection == 1
						&& !(bullet.intersects(b) && ((!shape[10] || !shape[14])
								|| (shape[9] && shape[10] && shape[13] && shape[14])))) {
			...
			if (border[2] != null) {
				if (bullet.intersects(border[2]) && bulletdirection == 0
						&& !(bullet.intersects(d) && ((!shape[10] || !shape[14])
								|| (shape[9] && shape[10] && shape[13] && shape[14])))) {
			...
			if (border[2] != null) {
				if (bullet.intersects(border[2]) && bulletdirection == 3
						&& !(bullet.intersects(a) && ((!shape[4] || !shape[5])
								|| (shape[4] && shape[5] && shape[8] && shape[9])))) {
			...
			if (border[2] != null) {
				if (bullet.intersects(border[2]) && bulletdirection == 2
						&& !(bullet.intersects(b) && ((!shape[4] || !shape[5])
								|| (shape[4] && shape[5] && shape[8] && shape[9])))) {
		...
		if (border[3] != null) {
			...
			if (border[3] != null) {
				if (bullet.intersects(border[3]) && bulletdirection == 1
						&& !(bullet.intersects(a) && ((!shape[9] || !shape[13])
								|| (shape[9] && shape[10] && shape[13] && shape[14])))) {
			...
			if (border[3] != null) {
				if (bullet.intersects(border[3]) && bulletdirection == 0
						&& !(bullet.intersects(c) && ((!shape[9] || !shape[13])
								|| (shape[9] && shape[10] && shape[13] && shape[14])))) {
			...
			if (border[3] != null) {
				if (bullet.intersects(border[3]) && bulletdirection == 3
						&& !(bullet.intersects(a) && ((!shape[6] || !shape[7])
								|| (shape[6] && shape[7] && shape[10] && shape[11])))) {
			...
			if (border[3] != null) {
				if (bullet.intersects(border[3]) && bulletdirection == 2
						&& !(bullet.intersects(b) && ((!shape[6] || !shape[7])
								|| (shape[6] && shape[7] && shape[10] && shape[11])))) {
